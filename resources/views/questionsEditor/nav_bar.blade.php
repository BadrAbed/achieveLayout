        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav ">
                ...
                @if(auth()->check())
                    ...
                    <li class="{{request()->is("QuestionsEditor/home")?"active":""}}">
                        <a href="{{url('QuestionsEditor/home')}}">
                            <center><span class="fa fa-home"></span><br></center>
                            الرئيسية
                            <span class="sr-only">(current)</span>
                        </a>
                    </li>
                    <li class="{{request()->is("QuestionsEditor/index")?"active":""}}">
                        <a href="{{url("QuestionsEditor/index")}}">
                            <center><span class="fa fa-play-circle"></span><br></center>
                            عرض الدروس
                        </a>
                    </li>
                    <li class="{{request()->is("QuestionsEditor/MyLessonsView")?"active":""}}">
                        <a href="{{url('QuestionsEditor/MyLessonsView')}}">
                    ...
                    <li class="{{request()->is("QuestionsEditor/ResendingQuestions/")?"active":""}}">
                        <a href="{{url('QuestionsEditor/ResendingQuestions/')}}">
