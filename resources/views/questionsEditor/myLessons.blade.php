            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-green">
                    <div class="panel-heading">
                        <h3 class="text-center"><span class="fa fa-window-restore"></span>&nbsp;&nbsp; دروس تحت المراجعة
                        </h3>
                    </div>
                                ...
                                $("#jsGrid").jsGrid({
                                    ...
                                    controller: {
                                        loadData: function (filter) {
                                            ...
                                            return $.ajax({
                                                type: "GET",
                                                url: '{{url("QuestionsEditor/MyLessons")}}',
                                                data: filter,
                                                dataType: "json",
                                    ...
                                    fields: [
...

                                        {
                                            ...
                                            itemTemplate: function (_, item) {
                                                ...
                                                createQuestions = <?=json_encode(url('QuestionsEditor/create/Questions/'.\App\Http\OwnClasses\STUDENT_ASSIGNED_LESSON_PLANS_ENUMS::GET_SHORT_QUESTIONS_TAB_ENUM))?>+"/" + item.ID;

                                                Edit = <?=json_encode(url('allQuestions'))?>+"/" + item.ID;
                                                SendToQuestionReviewer = <?=json_encode(url('QuestionsEditor/SendToQuestionReviewer'))?>+"/" + item.ID;
                                                ...
                                                return $('' +
                                                    ...
                                                    '<a class="btn btn-info btn-sm"  style="display: inline;margin-left:5px ;" href="' + createQuestions + '"> <span class="fa fa-desktop" aria-hidden="true"></span> &nbsp;ادخال الاسئلة</a>' +
                                                    '<a class="btn btn-warning btn-sm"  style="display: inline;margin-left:5px ;" href="' + SendToQuestionReviewer + '"> <span class="fa fa-arrow-circle-left" aria-hidden="true"></span> &nbsp;ارسال الى المراجعة  </a>' +
                                                    '' +
                                                    '' +
                                                    '');
