            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-green">
                    <div class="panel-heading">
                        <h3 class="text-center"><span class="fa fa-window-restore"></span>&nbsp;&nbsp;دروس تحت المراجعه
</h3>
                    </div>
                                ...
                                $("#jsGrid").jsGrid({
                                    ...
                                    controller: {
                                        loadData: function (filter) {
                                            ...
                                            return $.ajax({
                                                type: "GET",
                                                url: '{{url("publisher/AjaxMyLessons")}}',
                                                data: filter,
                                                dataType: "json",
                                    ...
                                    fields: [
...

                                        {
                                            ...
                                            itemTemplate: function (_, item) {
                                                ...
                                                publish = <?=json_encode(url('publisher/publish'))?>+"/" + item.ID;
                                                refused = <?=json_encode(url('publisher/refused'))?>+"/" + item.ID;
                                                ...
                                                return $('' +
                                                    ...
                                                    '<a class="btn btn-info btn-sm"  style="display: inline;margin-left:5px ;" href="' + publish + '"> <span class="fa fa-desktop" aria-hidden="true"></span> &nbsp;نشر</a>' +
                                                    '' +
                                                    '' +
                                                    '');
