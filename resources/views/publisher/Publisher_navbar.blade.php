        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav ">
                ...
                @if(auth()->check())
                    ...
                    <li class="{{request()->is("publisher/AllLessons/view")?"active":""}}">
                        <a href="{{url("publisher/AllLessons/view")}}">
                            <center><span class="fa fa-play-circle"></span><br></center>
                            عرض الدروس
                        </a>
                    </li>
                    <li class="{{request()->is("publisher/myLessonsView")?"active":""}}">
                        <a href="{{url("publisher/myLessonsView")}}">
                            <center><span class="fa fa-list"></span><br></center>
                            دروس تحت المراجعه
                        </a>
                    </li>
                    <li class="{{request()->is("publisher/resendingLessons")?"active":""}}">
                        <a href="{{url('publisher/resendingLessons')}}">
