        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav ">
                ...
                @if(auth()->check())
                    ...
                    <li class="{{request()->is("QuestionsReviewer/home")?"active":""}}">
                        <a href="{{url('QuestionsReviewer/home')}}">
                            <center><span class="fa fa-home"></span><br></center>
                            الرئيسية
                            <span class="sr-only">(current)</span>
                        </a>
                    </li>
                    <li class="{{request()->is("QuestionsReviewer/index")?"active":""}}">
                        <a href="{{url("QuestionsReviewer/index")}}">
                            <center><span class="fa fa-play-circle"></span><br></center>
                            عرض الدروس
                        </a>
                    </li>
                    <li class="{{request()->is("QuestionsReviewer/MyLessonsView")?"active":""}}">
                        <a href="{{url('QuestionsReviewer/MyLessonsView')}}">
                            <center><span class="fa fa-file"></span><br></center>
                            دروسى
                        </a>
                    </li>

                    <li class="{{request()->is("QuestionsReviewer/ResendingQuestions")?"active":""}}">
                        <a href="{{url('QuestionsReviewer/ResendingQuestions')}}">
