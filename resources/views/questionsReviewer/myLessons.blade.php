                                ...
                                $("#jsGrid").jsGrid({
                                    ...
                                    controller: {
                                        loadData: function (filter) {
                                            ...
                                            return $.ajax({
                                                type: "GET",
                                                url: '{{url("QuestionsReviewer/MyLessons")}}',
                                                data: filter,
                                                dataType: "json",
                                    ...
                                    fields: [
...

                                        {
                                            ...
                                            itemTemplate: function (_, item) {
                                                ...
                                                createQuestions = <?=json_encode(url('QuestionsEditor/create/Questions'))?>+"/" + item.ID;

                                                Edit = <?=json_encode(url('allQuestions'))?>+"/" + item.ID;
                                                SendToLangReview = <?=json_encode(url('QuestionsReviewer/SendToLangReview'))?>+"/" + item.ID;
                                                ...
                                                return $('' +
                                                    ...
                                                    '<a class="btn btn-warning btn-sm"  style="display: inline;margin-left:5px ;" href="' + SendToLangReview + '"> <span class="fa fa-arrow-circle-left" aria-hidden="true"></span> &nbsp;ارسال الى المراجعة  </a>' +
                                                    '' +
                                                    '' +
                                                    '');
