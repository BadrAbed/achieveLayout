        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav ">
                ...
                @if(auth()->check())
                    ...
                    <li class="{{request()->is("Reviewer/home")?"active":""}}">
                        <a href="{{url('Reviewer/home')}}">
                            <center><span class="fa fa-home"></span><br></center>
                            الرئيسية
                            <span class="sr-only">(current)</span>
                        </a>
                    </li>
                    <li class="{{request()->is("Reviewer/lessons")?"active":""}}">
                        <a href="{{url("Reviewer/lessons")}}">
                            <center><span class="fa fa-play-circle"></span><br></center>
                            عرض الدروس
                        </a>
                    </li>
                    <li class="{{request()->is("Reviewer/MyLessons/view")?"active":""}}">
                        <a href="{{url('Reviewer/MyLessons/view')}}">
                            <center><span class="fa fa-list"></span><br></center>
                            دروسى
                        </a>
                    </li>
                    <li class="{{request()->is("Reviewer/under/review")?"active":""}}">
                        <a href="{{url('Reviewer/under/review/')}}">
                    ...
                    <li class="{{request()->is("Reviewer/resendingLessons")?"active":""}}">
                        <a href="{{url('Reviewer/resendingLessons')}}">
