                ...
                <div class="panel panel-green">
                    ...
                    <div class="panel-body text-center">
                        ...
                        <div class="row text-center">
                            <div class="col-md-6 ">
                                <p class=" text-center"><i class="fa fa-window-restore"></i>&nbsp;&nbsp; الصفوف الدراسية

                            <div class="col-md-6">

                                <ul id="sortable2" class="connectedSortable">
                                    <li class="ui-state-default" value="1" id="bb"><a
                                                href="#"> tewggfjhts </a></li>
                                    <li class="ui-state-default" value="1" id="bb"><a
                                                href="#"> teteres </a></li>
                                    <li class="ui-state-default" value="1" id="bb"><a
                                                href="#"> teerts </a></li>
                        ...
                        <button class="btn btn-md btn-success" type="submit" onclick="change();"><span
                                    class="fa fa-plus"></span>&nbsp;أضف الترتيب
                        </button>
...
@section("OldJqueryVersion")
    ...
    <script>
        ...
        function change() {
            ...
            $.ajax({
                type: "GET",
                url: '{{url("addSortingEduLevels")}}/?ordering=' + arr + '+&length=' + length + '+&planID=' + planid + '',
