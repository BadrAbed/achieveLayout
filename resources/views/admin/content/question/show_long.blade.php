            ...
            <div class="row">
                <div class="tab-container">
                    ...
                    <section id="content5">
                        ...
                        $answer = DB::table('questions')->where('type', 'addationquest')->where('questions.content_id', $content_id)->
                        join('answers_questions', function ($join) {
                            ...
                            ->get()->count();
                        $questrestult = DB::table('questions')->where('content_id', $content_id)->where('type', 'addationquest')->count();
                        ...
                        <table class="vocabulary-table">
                            ...
                            @foreach($answeraddationquest as $answer)
                                <tr>
                                    <td>
                                        {{$answer->question}}</td>
                        ...
                        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    @foreach($answeraddationquest as $key => $value)
                        ...
                        <br>
                        <br>
                        @include('inc.issues',['tab_num'=>App\Http\OwnClasses\STUDENT_ASSIGNED_LESSON_PLANS_ENUMS::GET_LONG_QUESTIONS_TAB_ENUM])
                    </section>
                </div>
