            ...
            <div class="container main-container">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="ui input  fluid ">
                            {{ Form::password('password', Input::old('password'), array('class' => 'form-control','required','minlength="6"')) }}
                        </div>
                    </div>
                ...
                <div class="row form-group">
                    ...
                    <div style="z-index: 100" class="col-md-4">
                        ...
                        <select style="z-index: 100" name="countriesList[]" id="countries"
                                class="ui dropdown fluid" multiple data-actions-box="true" data-live-search="true" title="كل الدول">
                    ...
                    <div style="z-index: 100" class="col-md-4">
                        ...
                        <select style="z-index: 100" name="educationLevelList[]" id="educationLevels" class="ui dropdown fluid"
                                multiple
                                data-actions-box="true" data-live-search="true" title="كل المراحل">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-2">
                        {{ Form::label('is_permission', 'الصلاحية', array('class' => 'col-form-label')) }}
                    ...
                    <div  class="col-md-4">
                        ...
                        @else
                            ...
                            {{ Form::select('is_permission', $permissionListForleader,Input::old('is_permission'), array('class' => 'form-control ui dropdown fluid selection','style'=>'z-index: 100')) }}
                        @endif
                    </div>
