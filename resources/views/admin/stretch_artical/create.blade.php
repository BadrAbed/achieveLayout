...
@section('custom-content')
    ...
    {{ Form::open(array('url' => url("stretch-artical/store/$content_id"), 'files'=>'true')) }}
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-append">
                                <div class="upload-btn-wrapper ">
                                    <button class="{{ $errors->has('sound') ? 'btnme-error' : 'btnme'}}" ><span class="fa fa-plus-circle"></span>&nbsp;تحميل الملف </button>
