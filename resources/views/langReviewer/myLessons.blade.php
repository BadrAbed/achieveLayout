            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-green">
                    <div class="panel-heading">
                        <h3 class="text-center"><span class="fa fa-window-restore"></span>&nbsp;&nbsp; دروس تحت المراجعة</h3>
                    </div>
                                ...
                                $("#jsGrid").jsGrid({
                                    ...
                                    controller: {
                                        loadData: function (filter) {
                                            ...
                                            return $.ajax({
                                                type: "GET",
                                                url: '{{url("LangReviewer/AjaxMyLessons")}}',
                                                data: filter,
                                                dataType: "json",
                                    ...
                                    fields: [
...

                                        {
                                            ...
                                            itemTemplate: function (_, item) {
                                                ...
                                                review = <?=json_encode(url('LangReviewer/LangReviewerSendToPublisher'))?>+"/" + item.ID;
                                                refused = <?=json_encode(url('LangReviewer/LangReviewerRefuse'))?>+"/" + item.ID;
                                                ...
                                                return $('' +
                                                    ...
                                                    '<a class="btn btn-danger "  style="display: inline;margin-left:5px ;" href="' + refused + '"> <span class="fa fa-anchor" aria-hidden="true"></span> &nbsp;رفض</a>' +
                                                    ...
                                                    '<a class="btn btn-info btn-sm"  style="display: inline;margin-left:5px ;" href="' + review + '"> <span class="fa fa-desktop" aria-hidden="true"></span> &nbsp;مراجعه</a>' +
                                                    '' +
                                                    '' +
                                                    '');
