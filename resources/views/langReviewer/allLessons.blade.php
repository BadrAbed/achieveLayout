                                ...
                                $("#jsGrid").jsGrid({
                                    ...
                                    controller: {
                                        loadData: function (filter) {
                                            ...
                                            return $.ajax({
                                                type: "GET",
                                                url: '{{url("LangReviewer/AjaxAllLessons")}}',
                                                data: filter,
                                                dataType: "json",
                                    ...
                                    fields: [
...

                                        {
                                            ...
                                            itemTemplate: function (_, item) {
                                                ...
                                                Assign = <?=json_encode(url('LangReviewer/assignLessonToAudit'))?>+"/" + item.ID;
                                                ...
                                                return $('' +
                                                    ...
                                                    '<a class="btn btn-primary btn-sm"  style="display: inline;margin-left:5px ;" href="' + Assign + '"> <span class="fa fa-desktop" aria-hidden="true"></span> &nbsp;مراجعة الدرس </a>' +
                                                    '' +
                                                    '' +
                                                    '');
